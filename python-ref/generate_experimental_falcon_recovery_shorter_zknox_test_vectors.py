...
file = open("../test/experimental/ZKNOXFalconRecoveryShorterVectors.t.sol", 'w')
n = 512
...
header = """
// code generated using pythonref/generate_experimental_falcon_recovery_shorter_zknox_test_vectors.py.
pragma solidity ^0.8.25;

import {Test, console} from "forge-std/Test.sol";
import "../../src/ZKNOX_NTT.sol";
import "../../src/experimental/ZKNOX_falconrec_shorter.sol";

contract ZKNOX_FalconRecShorterTest is Test {
    ZKNOX_falconrec_shorter falconrec;
    ...
    function setUp() public {
        ...
        falconrec = new ZKNOX_falconrec_shorter(ntt);
    }"""
file.write(header)
...
for (i, message) in enumerate(list_of_messages):
    ...
    file.write("ZKNOX_falconrec_shorter.Signature memory sig;\n")
