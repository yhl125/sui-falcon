...
for (XOF, impl_str) in [(KeccakPRNG, ''), (KeccaXOF, 'Tetration')]:
    ...
    header = """
    // code generated using pythonref/generate_deprecated_falcon_recovery_test_vectors.py.
    ...
    for (i, message) in enumerate(list_of_messages):
        ...
        file.write(
            "recovered_pk_{} = falconrec.recover(message, sig,".format(i) + str(XOF == KeccakPRNG).lower() + ");\n")
