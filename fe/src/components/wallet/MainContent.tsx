...
export const MainContent: React.FC<MainContentProps> = ({
  ...
  const formattedEd25519PubKey = formatEd25519PublicKey(
    hybridWallet?.ed25519_pubkey || null
  );
  ...
  React.useEffect(() => {
    ...
    isHybridWalletLoading,
    hybridWalletError,
    formattedFalconPubKey,
    formattedEd25519PubKey,
  ]);
              ...
              <div style={{ marginBottom: "15px" }}>
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigator.clipboard.writeText(hybridWalletId || "")
                    }
                  >
                    Copy
                  </button>
              ...
              <div style={{ marginBottom: "15px" }}>
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigator.clipboard.writeText(formattedFalconPubKey)
                    }
                  >
                    Copy
                  </button>
              ...
              <div style={{ marginBottom: "15px" }}>
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigator.clipboard.writeText(formattedEd25519PubKey)
                    }
                  >
                    Copy
                  </button>
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = "translateY(-2px)";
                e.currentTarget.style.boxShadow =
                  "0 12px 35px rgba(74, 158, 255, 0.4)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow =
