...
export const StartPage: React.FC<StartPageProps> = ({ onStart }) => {
  ...
  const { isLoading, isInitialized, error, currentStep } = useFalcon({
    autoInitialize: true,
  ...
  useEffect(() => {
    if (currentAccount && isInitialized) {
      ...
      if (wallet.hasFalconKeys()) {
        ...
        console.log(
          "⚠️ Wallet connected but no Falcon keys - will need to generate"
        );
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: "40px",
                  background:
                    "radial-gradient(circle, rgba(64, 224, 208, 0.3), transparent)",
                  borderRadius: "50%",
            ...
            >
              ...
              <ConnectButton
                ...
                onMouseLeave={(e) => {
                  ...
                  e.currentTarget.style.textShadow = `0 0 10px ${
                    isWalletReady
                      ? "rgba(64, 224, 208, 0.8)"
                      : "rgba(255, 165, 0, 0.8)"
                  }`;
